        ...
        <View style={{ flexDirection:'row'}}>
          <View style={{ width:'50%', alignItems:'center', justifyContent:'center'}}>
            <CardView
              ...
              cardMaxElevation={4}
              cornerRadius={10}>
              <TouchableOpacity onPress={view_orders.bind(this,'active','Active')} style={{ padding:10, alignItems:'center', justifyContent:'center', backgroundColor:'#a7c661', height:130, width:150 }}>
          ...
          <View style={{ width:'50%', alignItems:'center', justifyContent:'center'}}>
            <CardView
              ...
              cardMaxElevation={4}
              cornerRadius={10}>
              <TouchableOpacity onPress={view_orders.bind(this,'upcoming','Upcoming')} style={{ padding:10, alignItems:'center', justifyContent:'center', backgroundColor:'#619fc6', height:130, width:150 }}>
                <View style={{ width: 50, height:50 }}>
        ...
        <View style={{ flexDirection:'row'}}>
          <View style={{ width:'50%', alignItems:'center', justifyContent:'center'}}> 
            <CardView
              ...
              cardMaxElevation={4}
              cornerRadius={10}>
              <TouchableOpacity onPress={view_orders.bind(this,'completed','Completed')} style={{ padding:10, alignItems:'center', justifyContent:'center', backgroundColor:'#61c6c1', height:130, width:150 }}>
                <View style={{ width: 50, height:50 }}>
          ...
          <View style={{ width:'50%', alignItems:'center', justifyContent:'center'}}>
            <CardView
              ...
              cardMaxElevation={4}
              cornerRadius={10}>
              <TouchableOpacity onPress={view_orders.bind(this,'cancelled','Cancelled')} style={{ padding:10, alignItems:'center', justifyContent:'center', backgroundColor:'#EE4B2B', height:130, width:150 }}>
                <View style={{ width: 50, height:50 }}>
